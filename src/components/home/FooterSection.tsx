...
export default function FooterSection({ profile, t }: FooterSectionProps): JSX.Element {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="py-10 border-t border-gray-200 dark:border-gray-700">
      <div className="max-w-6xl mx-auto px-4 space-y-6 text-sm text-muted-foreground">
        <div className="flex flex-col md:flex-row items-center justify-between gap-3">
          <p>© {currentYear} {profile?.name || 'Yohann Di Crescenzo'}. Tous droits réservés.</p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <a href={profile?.github_url || '#'} target="_blank" rel="noreferrer" className="hover:text-primary transition-colors">
            GitHub
          </a>
        </div>
      </div>
