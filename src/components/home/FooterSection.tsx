...
export default function FooterSection({ profile, t }: FooterSectionProps): JSX.Element {
  ...
  return (
    <footer className="py-10 border-t border-gray-200 dark:border-gray-700">
      <div className="flex flex-row item-center justify-between max-w-6xl mx-auto px-4 space-y-6 text-sm text-muted-foreground">
        <p>
          © {currentYear} {profile?.name || 'Yohann Di Crescenzo'}. Tous droits réservés.
        </p>
        <Link
          href="https://github.com/YohannDCz/portfolio-react"
