...
/**
 * Instagram-style profile image modal with click trigger
 * @param props - Profile image modal properties
 * @returns JSX Element for profile image modal
 */
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center min-h-[400px] max-h-[80vh] p-8">
              <Avatar className="h-80 w-80 ring-4 ring-white/20">
                <AvatarImage alt={alt} src={src} className="object-cover" />
