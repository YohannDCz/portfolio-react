...
export default function ProjectImage({ 
  ...
  if (!src || imageError) {
    return (
      <div className={`bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 dark:from-slate-800 dark:via-slate-700 dark:to-slate-600 ${className} relative overflow-hidden`}>
