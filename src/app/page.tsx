    ...
    >
              ...
              <div className={`mt-6 ${getDirectionalClass('flex flex-wrap gap-3')}`}>
                <a href="#contact">
                  <Button className={getDirectionalClass('flex items-center')}>
                    {t.contactMe}
                    <ArrowUpRight
                      className={`${isRTL ? 'mr-2' : 'ml-2'} h-4 w-4 no-rtl-transform`}
                    />
                  </Button>
                </a>
            ...
            platforms?.map((f) => (
              <Card key={f.id}>
                <CardHeader className="pb-2">
                  ...
                  <CardDescription>
                    {getLocalizedText(f, 'description', currentLang)}
                  </CardDescription>
                </CardHeader>
                <CardContent className={getDirectionalClass('flex items-center justify-between')}>
                  ...
                  <a href={f.url} target="_blank" rel="noreferrer">
                    <Button
                      size="sm"
                      variant="outline"
                      className={getDirectionalClass('flex items-center')}
                    >
                      {t.open}
                      <ArrowUpRight
                        className={`${isRTL ? 'mr-1' : 'ml-1'} h-4 w-4 no-rtl-transform`}
                      />
                    </Button>
                  </a>
                </CardContent>
            ...
            <CardContent>
              <ul className="grid gap-3 text-sm">
                ...
                <li>
                  ...
                  {getLocalizedText(profile, 'availability_hours', currentLang) ||
                    '10–20h / semaine'}
                </li>
                <li>
            ...
            <CardContent>
              <form onSubmit={handleContactSubmit} className="grid gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href={`mailto:${profile?.email || 'YohannDCz@gmail.com'}`}
          ...
          <Card>
            ...
            <CardContent className="grid gap-3">
              ...
              <SocialLink
                ...
                label={profile?.email || 'YohannDCz@gmail.com'}
              />
            </CardContent>
          </Card>
        </div>
      ...
      <footer className="py-10 border-t border-gray-200 dark:border-gray-700">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} {profile?.name || 'Yohann Di Crescenzo'}. Tous droits
            réservés.
          </p>
